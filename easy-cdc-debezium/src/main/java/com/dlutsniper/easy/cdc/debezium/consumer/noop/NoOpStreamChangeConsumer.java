package com.dlutsniper.easy.cdc.debezium.consumer.noop;
...
public class NoOpStreamChangeConsumer extends BaseChangeConsumer implements DebeziumEngine.ChangeConsumer<ChangeEvent<Object, Object>> {
    ...
    public NoOpStreamChangeConsumer(Properties debeziumProperties, StreamNameMapper customStreamNameMapper) {
